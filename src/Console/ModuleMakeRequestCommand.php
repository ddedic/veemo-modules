...
use Veemo\Modules\Handlers\ModuleMakeRequestHandler;
...
class ModuleMakeRequestCommand extends Command
{
	...
	/**
	 * @var \Veemo\Modules\Handlers\ModuleMakeRequestHandler
	 */
	protected $handler;
	 ...
	 *
	 * @param \Veemo\Modules\Handlers\ModuleMakeRequestHandler $handler
	 */
