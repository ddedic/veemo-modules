<?php
namespace Veemo\Modules\Handlers;

use Veemo\Modules\Modules;
...
class ModuleMakeMigrationHandler
{
	 ...
	 * Constructor method.
	 *
	 * @param \Veemo\Modules\Modules      $module
	 ...
	 *
	 * @param  \Veemo\Modules\Console\ModuleMakeMigrationCommand $console
	 * @param  string                                                  $slug
	 * @return string
	 */
